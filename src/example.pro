...
QT       += core gui svg network charts
...
HEADERS += \
    ...
    qfi_TC.h \
    example/WidgetSix.h \
    example/my_parameters.h \
    example/communication.h \
    example/thread.h \
    example/thread_updategui.h
...
SOURCES += \
    ...
    example/my_parameters.cpp \
    example/communication.cpp \
    example/thread.cpp \
    example/thread_updategui.cpp
